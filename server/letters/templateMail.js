      ...
      <ul>
       ...
       <li>-<br></li>
        ...
        <li><b>${objectMessage.review}</b></li>
          ...
          <br>
      <a href="${process.env._AXIOS_BASE_URL_}confirm-admin/${objectMessage.uid}?id=${ids}">
      Ссылка на подтверждение комментария: ${process.env._AXIOS_BASE_URL_}confirm-admin/${objectMessage.uid}?id=${ids}</a>
      <br>
      <br>
